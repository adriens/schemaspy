...
public class HtmlMultipleSchemasIndexPage extends HtmlFormatter {
    ...
    private void writeHeader(String databaseName, DatabaseMetaData meta, int numberOfSchemas, boolean showIds, String aSchema, LineWriter html) throws IOException {
        ...
        html.writeln("</h1></td>");
        html.writeln("  <td class='heading' align='right' valign='top' title='Adrien Sales'><span class='indent'>Generated by</span><br><span class='indent'><span class='signature'><a href='https://github.com/adriens/schemaspy' target='_blank'>SchemaSpy</a></span></span></td>");
        html.writeln(" </tr>");
        html.writeln("</table>");
