...
public class HtmlFormatter {
    ...
    protected void writeHeader(Database db, Table table, String text, boolean showOrphans, List<String> javascript, LineWriter out) throws IOException {
        ...
        out.writeln("</td>");;
        out.writeln("  <td class='heading' align='right' valign='top' title='Adrien Sales'><span class='indent'>Generated by</span><br><span class='indent'><span class='signature'><a href='https://github.com/adriens/schemaspy' target='_blank'>SchemaSpy</a></span></span></td>");
        out.writeln(" </tr>");
        out.writeln("</table>");
    }
    ...
    protected void writeGeneratedBy(String connectTime, LineWriter html) throws IOException {
        ...
        html.write("Generated by <span class='signature'><a href='https://github.com/adriens/schemaspy' target='_blank'>SchemaSpy</a></span> on ");
